...
class main_controller
{
	...
	{
		$l_message = !$this->config['bestpickrs_advseo_goodbye'] ? 'ADVSEO_HELLO' : 'ADVSEO_GOODBYE';
		$this->template->assign_var('ADVSEO_MESSAGE', $this->language->lang($l_message, $name));

		return $this->helper->render('@bestpickrs_advseo/advseo_body.html', $name);
	}
}
