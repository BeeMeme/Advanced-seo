...
class install_sample_data extends \phpbb\db\migration\migration
{
	...
	{
		return $this->config->offsetExists('bestpickrs_advseo_sample_int');
	}
	...
	public function update_data()
	{
		return [
			...
			['config.add', ['bestpickrs_advseo_sample_int', 0]],
			['config.add', ['bestpickrs_advseo_sample_str', '']],

			// Add a new config_text table setting
			['config_text.add', ['bestpickrs_advseo_sample', '']],

			// Add new permissions
			['permission.add', ['a_new_bestpickrs_advseo']], // New admin permission
			['permission.add', ['m_new_bestpickrs_advseo']], // New moderator permission
			['permission.add', ['u_new_bestpickrs_advseo']], // New user permission
			...
			['permission.permission_set', ['ROLE_ADMIN_FULL', 'a_new_bestpickrs_advseo']], // Give ROLE_ADMIN_FULL a_new_bestpickrs_advseo permission
			['permission.permission_set', ['ROLE_MOD_FULL', 'm_new_bestpickrs_advseo']], // Give ROLE_MOD_FULL m_new_bestpickrs_advseo permission
			['permission.permission_set', ['ROLE_USER_FULL', 'u_new_bestpickrs_advseo']], // Give ROLE_USER_FULL u_new_bestpickrs_advseo permission
			['permission.permission_set', ['ROLE_USER_STANDARD', 'u_new_bestpickrs_advseo']], // Give ROLE_USER_STANDARD u_new_bestpickrs_advseo permission
			['permission.permission_set', ['REGISTERED', 'u_new_bestpickrs_advseo', 'group']], // Give REGISTERED group u_new_bestpickrs_advseo permission
			['permission.permission_set', ['REGISTERED_COPPA', 'u_new_bestpickrs_advseo', 'group', false]], // Set u_new_bestpickrs_advseo to never for REGISTERED_COPPA

			// Add new permission roles
			['permission.role_add', ['advseo admin role', 'a_', 'a new role for admins']], // New role "advseo admin role"
			['permission.role_add', ['advseo moderator role', 'm_', 'a new role for moderators']], // New role "advseo moderator role"
			['permission.role_add', ['advseo user role', 'u_', 'a new role for users']], // New role "advseo user role"
