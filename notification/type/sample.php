...
/**
 * Advanced Seo Notification class.
 */
class sample extends \phpbb\notification\type\base
{
	...
	{
		return 'bestpickrs.advseo.notification.type.sample';
	}
	...
	{
		return $this->language->lang('BESTPICKRS_ADVSEO_NOTIFICATION');
	}
	...
	{
		return $this->helper->route('bestpickrs_advseo_controller', $this->get_data('advseo_sample_name'));
	}
	...
	{
		$this->set_data('advseo_sample_name', $data['advseo_sample_name']);
